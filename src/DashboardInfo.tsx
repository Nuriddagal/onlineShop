      ...
      <div className="dashboard_info">
        <h1 className='dashboard__title'>
          ...
          <p className="dashboard__rating dashboard__info-item info-item">
            ...
            <span><StarSvg />{product.rating}</span></p>
